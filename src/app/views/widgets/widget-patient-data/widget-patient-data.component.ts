...
export class WidgetPatientDataComponent implements OnInit {
  ...
  checkFormCondition() {
    ...
    let patientName = this.model.patientName
      ? this.model.patientName.trim()
      : "";
    let sex = this.isEmpty(this.model.sex) ? null : this.model.sex;
    let birthPlace = this.isEmpty(this.model.birthPlace)
      ? null
      : this.model.birthPlace;
    ...
    let officePhone = this.model.officePhone
      ? this.model.officePhone.trim()
      : "";
    let email = this.model.email ? this.model.email.trim() : "";
    let contactName = this.model.contactName
      ? this.model.contactName.trim()
      : "";
    let contactMobile = this.model.contactMobile
      ? this.model.contactMobile.trim()
      : "";
    let contactPhone = this.model.contactPhone
      ? this.model.contactPhone.trim()
      : "";
    let nationalidType = this.isEmpty(this.model.nationalidType)
      ? null
      : this.model.nationalidType;
    let nationalIdNo = this.model.nationalIdNo
  ...
  async getFilePdf() {
    ...
    let data = await this.payerService
      .getPrint(payload)
      .toPromise()
      .then((res) => {
        this.isLoadingCheckEligible = false;
