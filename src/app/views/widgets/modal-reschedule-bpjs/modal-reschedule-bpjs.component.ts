...
@Component({
  selector: 'app-modal-reschedule-bpjs',
  templateUrl: './modal-reschedule-bpjs.component.html',
  styleUrls: ['./modal-reschedule-bpjs.component.css']
})
export class ModalRescheduleBpjsComponent implements OnInit {
