...
@Component({
  ...
  templateUrl: './widget-appointment-list-bpjs.component.html',
  styleUrls: ['./widget-appointment-list-bpjs.component.css']
})
export class WidgetAppointmentListBpjsComponent implements OnInit {
